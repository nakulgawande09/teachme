...
const STATES = [
  ...
  ['10 words',          () => router.pickWords()],
  ['10 turn invite',    () => dispatch(A.TURN_STEP, { step: 'invite' })],
  ['10 turn prompt',    () => dispatch(A.TURN_STEP, { step: 'prompt' })],
  ['10 turn record',    () => dispatch(A.TURN_STEP, { step: 'record' })],
  ['10 turn playback',  () => dispatch(A.TURN_STEP, { step: 'playback' })],
  ['10 turn settle',    () => dispatch(A.TURN_STEP, { step: 'settle' })],
  ['10 mark got',       () => dispatch(A.TURN_MARK, { mark: 'got' })],
